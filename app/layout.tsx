...
export default function Layout({children}:{children:React.ReactNode}){return <html lang="en-AU"><body><a className="skip-link" href="#main">Skip to content</a><header><div className="header-inner"><Link href="/" className="brand"><span className="brand-mark">tc<span>.</span></span><span>Tender Collection</span></Link><nav aria-label="Main navigation"><Link href="/">Browse tenders</Link><Link href="/about/">About the feed</Link></nav></div></header><main id="main">{children}</main><footer><div><strong>Tender Collection</strong><span>Australian opportunities. Freely accessible.</span></div><Notice/><Link href="/about/">Sources & accuracy →</Link></footer></body></html>}
