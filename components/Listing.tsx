...
export default function Listing({items,index,history=false}:{items:ListingType[];index:SearchIndex;history?:boolean}){
 ...
 <div className="card-title-row"><h2><Link href={tenderPath(t)}>{t.title}</Link></h2><a className="source-link" href={sourceUrl(t)} target="_blank" rel="noopener noreferrer">View source ↗</a></div>
